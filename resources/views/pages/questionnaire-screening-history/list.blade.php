<x-app-layout>
    <x-slot name="page_title">Riwayat</x-slot>
    <x-slot name="page_description">
        <x-atoms.header-description icon="info" description="Menu <b>'Riwayat'</b> berfungsi untuk melihat data riwayat pada sistem." />
    </x-slot>
    <x-slot name="page_breadcrumb">
        <x-atoms.breadcrumb :links="[
            ['name' => 'Dasbor', 'url' => route('redirect.auth')],
            ['name' => 'Riwayat', 'url' => route('history-screening.list')],
            ['name' => 'Daftar Riwayat', 'url' => route('history-screening.list')],
        ]" />
    </x-slot>
    ...
    <div class="container-fluid bg-white rounded mt-4 shadow">
        <div class="row p-3">
            <div class="col-md-12">
                <form method="GET" action="{{ route('history-screening.list') }}" class="row align-items-center p-3">
                    <div class="col-md-7">
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="text-white text-center fw-bold align-middle" style="background-color: #21336e;">Tanggal</th>
                                <th scope="col" class="text-white text-center fw-bold align-middle" style="background-color: #21336e;">Kode</th>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        <div class="widget-connection-request-actions d-flex">
                                            @can('detail_history_screening')
                                                <x-atoms.pure-button-redirect-parameter route="{{ route('history-screening.detail', [$item->questionnaire_id, $item->id]) }}" class="btn-warning btn-style-light w-100" icon="preview" label="Lihat" />
                                            @endcan
                                        </div>
                                    </td>
                                </tr>
