<x-app-layout>
    ...
    @endpush
    <x-slot name="page_title"> Tambah Mitra </x-slot>
    <x-slot name="page_description">
        <x-atoms.header-description icon="info" description="Menu <b>'Tambah Mitra'</b> berfungsi untuk menambahkan data baru mitra pada sistem." />
    </x-slot>
    <x-slot name="page_action">
        ...
        @endcan
        @can('create_partner')
            <x-atoms.pure-button-redirect route="master-partner.create" class="btn-warning" icon="restart_alt" label="Atur Ulang" />
        @endcan
    </x-slot>
    <x-slot name="page_breadcrumb">
        <x-atoms.breadcrumb :links="[
            ...
            ['name' => 'Tambah Mitra', 'url' => route('master-partner.create')],
        ]" />
    </x-slot>

    <div class="container-fluid bg-white rounded mt-4 shadow">
        <form method="POST" class="row g-3 p-5 mt-1" action="{{ route('master-partner.store') }}">
            @csrf
            <div class="col-md-6">
                <x-atoms.form-input id="name" label="Nama Mitra" required="true" type="text" name="name" />
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                <x-atoms.form-input id="google_maps_url" label="Tautan Google Maps" required="true" type="url" name="google_maps_url" />
            </div>
            <div class="col-md-12">
