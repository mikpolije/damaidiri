<x-app-layout>
    ...
    <div class="container-fluid bg-white rounded mt-4 shadow">
        <div class="row p-3">
            <div class="col-md-12">
                <form method="GET" action="{{ route('master-journal.journal-history.list', $detail_journal->id) }}" class="row align-items-center p-3">
                    <div class="col-md-7">
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="text-white text-center fw-bold align-middle" style="background-color: #21336e;">Kode Respon Jurnal</th>
                                <th scope="col" class="text-white text-center fw-bold align-middle" style="background-color: #21336e;">Status response</th>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        <div class="widget-connection-request-actions d-flex">
                                            @can('detail_journal_history')
                                                <x-atoms.pure-button-redirect-parameter route="{{ route('master-journal.journal-history.detail', [$detail_journal->id, $item->id]) }}" class="btn-warning btn-style-light w-100" icon="preview" label="Lihat" />
                                            @endcan
                                        </div>
                                    </td>
                                </tr>
